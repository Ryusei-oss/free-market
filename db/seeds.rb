...
if !Category.find_by_id(1)
  parents_array = ["レディース"]
  parents_child_array = ['トップス','ジャケット/アウター','パンツ','スカート','ワンピース','靴','ルームウェア/パジャマ','レッグウェア','帽子','バッグ','アクセサリー','ヘアアクセサリー','小物','時計']
                        #,['ここにも記述が必要の可能性あり']
  ...
  parents_array.each_with_index do |parent, i|
    ...
    parents_child_array.each_with_index do |child, i|
      child = parent.children.create(name: child)
      parents_grandchild_array[i].each do |grandchild|
